...
var Calendar = (function (_Component) {
  ...
  {
    key: 'chooseMonth',
    value: function chooseMonth(direction, event) {
      ...
      return _react2['default'].createElement(
        ...
        showMonthArrow ? _react2['default'].createElement(
          'button',
          {
            ...
            onClick: this.changeMonth.bind(this, -12) },
          _react2['default'].createElement('i', { style: onlyClasses ? undefined : _extends({}, styles['YearArrow'], styles['YearArrowPrev2']) }),
          _react2['default'].createElement('i', { style: onlyClasses ? undefined : _extends({}, styles['YearArrow'], styles['YearArrowPrev']) })
        ) : null,
        showMonthArrow ? _react2['default'].createElement(
          'button',
          {
        ...
        showMonthArrow ? _react2['default'].createElement(
          'button',
          {
            ...
            onClick: this.changeMonth.bind(this, +12) },
          _react2['default'].createElement('i', { style: onlyClasses ? undefined : _extends({}, styles['YearArrow'], styles['YearArrowNext']) }),
          _react2['default'].createElement('i', { style: onlyClasses ? undefined : _extends({}, styles['YearArrow'], styles['YearArrowNext2']) })
        ) : null,
        showMonthArrow ? _react2['default'].createElement(
          'button',
          {
