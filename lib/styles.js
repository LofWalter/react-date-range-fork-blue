...
exports['default'] = function () {
  ...
  return {
    ...
    YearArrow: _extends({}, defaultTheme.YearArrow, customTheme.YearArrow),

    MonthArrowPrev: _extends({}, defaultTheme.MonthArrowPrev, customTheme.MonthArrowPrev),

    YearArrowPrev: _extends({},defaultTheme.YearArrowPrev, customTheme.YearArrowPrev),

    YearArrowPrev2: _extends({},defaultTheme.YearArrowPrev2, customTheme.YearArrowPrev2),

    MonthArrowNext: _extends({}, defaultTheme.MonthArrowNext, customTheme.MonthArrowNext),

    YearArrowNext: _extends({},defaultTheme.YearArrowNext, customTheme.YearArrowNext),

    YearArrowNext2: _extends({},defaultTheme.YearArrowNext2, customTheme.YearArrowNext2),
